...
export default {
  ...
  'general.AuthController_bindGithubManual': ['POST', '/auth/bind/github/manual'],
  ...
  'general.LanguagesController_findAllPaginated': ['GET', '/languages/paginated'],
  ...
  'general.CorpusCategoriesController_findAllPaginated': ['GET', '/corpus-categories/paginated'],
  'general.CorpusCategoriesController_findByLanguageId': ['GET', '/corpus-categories/language/{languageId}'],
  'general.CorpusCategoriesController_findByDifficulty': ['GET', '/corpus-categories/difficulty/{difficulty}'],
  ...
  'general.CorpusCategoriesController_getDifficultyStats': ['GET', '/corpus-categories/stats/difficulty'],
  'general.CorpusCategoriesController_getLanguageStats': ['GET', '/corpus-categories/stats/language'],
  'general.CorpusCategoriesController_findOne': ['GET', '/corpus-categories/{id}'],
  'general.CorpusCategoriesController_remove': ['DELETE', '/corpus-categories/{id}'],
  'general.WordsController_create': ['POST', '/words'],
  'general.WordsController_findAllPaginated': ['GET', '/words/paginated'],
  'general.WordsController_findByLanguageId': ['GET', '/words/language/{languageId}'],
  'general.WordsController_findByCategoryId': ['GET', '/words/category/{categoryId}'],
  'general.WordsController_findByLanguageAndCategory': ['GET', '/words/language/{languageId}/category/{categoryId}'],
  'general.WordsController_searchWords': ['GET', '/words/search'],
  'general.WordsController_searchWordsPaginated': ['GET', '/words/search/paginated'],
  ...
  'general.SentencesController_findByCategoryId': ['GET', '/sentences/category/{categoryId}'],
  ...
  'general.SentencesController_searchSentencesPaginated': ['GET', '/sentences/search/paginated'],
  'general.SentencesController_getRandomSentences': ['GET', '/sentences/random'],
  'general.SentencesController_getLanguageStats': ['GET', '/sentences/stats/language'],
  'general.SentencesController_getCategoryStats': ['GET', '/sentences/stats/category'],
